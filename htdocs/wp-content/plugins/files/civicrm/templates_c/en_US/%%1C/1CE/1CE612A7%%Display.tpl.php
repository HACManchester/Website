<?php /* Smarty version 2.6.26, created on 2012-08-09 12:25:29
         compiled from CRM/Admin/Form/Preferences/Display.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Admin/Form/Preferences/Display.tpl', 36, false),array('function', 'docURL', 'CRM/Admin/Form/Preferences/Display.tpl', 36, false),array('function', 'help', 'CRM/Admin/Form/Preferences/Display.tpl', 119, false),)), $this); ?>
...
<?php echo '<script type="text/javascript">cj(document).ready(function() { if (cj(\'#editor_id\').val() == 4) cj(\'#crm-preferences-display-form-block-wysiwyg_input_format\').show(); });</script>'; ?>

                    <br /><span class="description"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>You will need to enable and configure several modules if you want to allow users to upload images while using a Druapl Default Editor.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?> <?php echo smarty_function_docURL(array('page' => 'Configuring CiviCRM to Use the Default Drupal Editor'), $this);?>
</span>
                </td>
            </tr>    
        <?php endif; ?>
